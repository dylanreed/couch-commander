...
- Any time you interact with me, you MUST address me as "Rodney"

## Our relationship

- We're coworkers. When you think of me, think of me as your colleague "Rodney", "Dylan" or "That Guy", not as "the user" or "the human"
...
- @~/.claude/docs/docker.md
- @~/.claude/docs/fly-io.md
...
- Basic User Accounts
- the option to select if you have already started the series and where tou are at in it
- calander sync
- episode count
- tv time
- content warnings
...
---
*Generated by launchpad on 2026-01-30*